...
this.uploadFileLink=b;this.addFileBtn=jQuery("#"+a+"_add_file_btn");this.addFileBtn.bind("click",{widgetId:a},EMarkdownEditor.showUploadFileDialog);this.addCutBtn=jQuery("#"+a+"_add_cut_btn");this.addCutBtn.bind("click",{widgetId:a},EMarkdownEditor.insertCut);this.mirrorEditor=eval(a+"_code_input_codemirror");this.mirrorEditor.on("change",(a)=>{d.codeInput.val(a.getValue())});this.markdownMirrorEditor=eval(a+"_codemirror");this.markdownMirrorEditor.on("change",(a)=>{d.textarea.val(a.getValue())});
this.markdownMirrorEditor.setOption("extraKeys",{F11(a){d.fullScreen()},Esc(a){d.widget.removeClass("markdown-fullscreen");this.fullscreen=!1;this.fullScreenButton.find("span").removeClass("mdi-fullscreen-exit");this.fullScreenButton.find("span").addClass("mdi-fullscreen")},"Ctrl-/":"toggleComment"});this.mirrorEditor.setOption("extraKeys",{"Ctrl-/":"toggleComment"})};
