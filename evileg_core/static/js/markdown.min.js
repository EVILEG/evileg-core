...
"lang-sh":"text/x-sh","lang-xhtml":"htmlmixed","lang-xml":"text/html","lang-xsl":"text/html"},EMarkdownEditor=function(a,c,b){c=void 0===c?"":c;b=void 0===b?"":b;var d=this;this.fullscreen=!1;this.id=a;this.widget=jQuery("#"+a+"_markdown_widget");this.textarea=jQuery("#"+a);this.tabPreviewLink=jQuery("#"+a+"_tab_preview_link");this.tabPreviewLink.bind("shown.bs.tab",{widgetId:a},EMarkdownEditor.updatePreview);this.fullScreenButton=jQuery("#"+a+"_fullscreen_btn");this.fullScreenButton.on("click",(a)=>
{a.preventDefault();d.fullScreen()});this.linkDialog=jQuery("#"+a+"_add_link_dialog");this.addLinkBtn=jQuery("#"+a+"_add_link_btn");this.addLinkBtn.bind("click",{dialog:this.linkDialog},EMarkdownEditor.showDialog);this.insertLinkBtn=jQuery("#"+a+"_insert_link_btn");this.insertLinkBtn.bind("click",{widgetId:a},EMarkdownEditor.insertLink);this.linkText=jQuery("#"+a+"_link_text");this.linkUrl=jQuery("#"+a+"_link_url");this.codeDialog=jQuery("#"+a+"_code_dialog");this.addCodeBtn=jQuery("#"+a+"_add_code_btn");
this.addCodeBtn.bind("click",{dialog:this.codeDialog},EMarkdownEditor.showDialog);this.insertCodeBtn=jQuery("#"+a+"_insert_code_btn");this.insertCodeBtn.bind("click",{widgetId:a},EMarkdownEditor.insertCode);this.selectCode=jQuery("#"+a+"_select_code");this.selectCode.bind("change",{widgetId:a},EMarkdownEditor.onSelectCode);this.codeInput=jQuery("#"+a+"_code_input");this.uploadLink=c;this.addImageBtn=jQuery("#"+a+"_add_image_btn");this.addImageBtn.bind("click",{widgetId:a},EMarkdownEditor.showUploadDialog);
this.uploadFileLink=b;this.addFileBtn=jQuery("#"+a+"_add_file_btn");this.addFileBtn.bind("click",{widgetId:a},EMarkdownEditor.showUploadFileDialog);this.addCutBtn=jQuery("#"+a+"_add_cut_btn");this.addCutBtn.bind("click",{widgetId:a},EMarkdownEditor.insertCut);try{this.mirrorEditor=eval(a+"_code_input_codemirror"),this.mirrorEditor.on("change",(a)=>{d.codeInput.val(a.getValue())}),this.mirrorEditor.setOption("extraKeys",{"Ctrl-/":"toggleComment"})}catch(f){console.log("Code editor not found")}try{this.markdownMirrorEditor=
eval(a+"_codemirror"),this.markdownMirrorEditor.on("change",(a)=>{d.textarea.val(a.getValue())}),this.markdownMirrorEditor.setOption("extraKeys",{F11(a){d.fullScreen()},Esc(a){d.widget.removeClass("markdown-fullscreen");d.fullscreen=!1;d.fullScreenButton.find("span").removeClass("mdi-fullscreen-exit");d.fullScreenButton.find("span").addClass("mdi-fullscreen")},"Ctrl-/":"toggleComment"})}catch(e){console.log("Markdown editor not found")}};
