...
this.markdownMirrorEditor.setOption("extraKeys",{F11(a){d.fullScreen()},Esc(a){d.widget.removeClass("markdown-fullscreen");d.fullscreen=!1;d.fullScreenButton.find("span").removeClass("mdi-fullscreen-exit");d.fullScreenButton.find("span").addClass("mdi-fullscreen")},"Ctrl-/":"toggleComment"});this.mirrorEditor.setOption("extraKeys",{"Ctrl-/":"toggleComment"})};
