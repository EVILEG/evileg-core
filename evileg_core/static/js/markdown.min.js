...
EMarkdownEditor.insertCode=(a)=>{a.preventDefault();if(a=EMarkdownEditor.get(a.data.widgetId)){var c=a.codeInput.val(),b=a.selectCode.val();if(0<c.length)return c="\n```"+b+"\n"+c+"\n```\n",EMarkdownEditor.restoreSelection(),a.textarea.insertAtCaret(c),a.codeInput.val(""),!0}return!1};
