...
"lang-sh":"text/x-sh","lang-xhtml":"htmlmixed","lang-xml":"text/html","lang-xsl":"text/html"},EMarkdownEditor=function(a,c,b){c=void 0===c?"":c;b=void 0===b?"":b;var d=this;this.id=a;this.textarea=jQuery("#"+a);this.tabPreviewLink=jQuery("#"+a+"_tab_preview_link");this.tabPreviewLink.bind("shown.bs.tab",{widgetId:a},EMarkdownEditor.updatePreview);this.linkDialog=jQuery("#"+a+"_add_link_dialog");this.addLinkBtn=jQuery("#"+a+"_add_link_btn");this.addLinkBtn.bind("click",{dialog:this.linkDialog},EMarkdownEditor.showDialog);
this.insertLinkBtn=jQuery("#"+a+"_insert_link_btn");this.insertLinkBtn.bind("click",{widgetId:a},EMarkdownEditor.insertLink);this.linkText=jQuery("#"+a+"_link_text");this.linkUrl=jQuery("#"+a+"_link_url");this.codeDialog=jQuery("#"+a+"_code_dialog");this.addCodeBtn=jQuery("#"+a+"_add_code_btn");this.addCodeBtn.bind("click",{dialog:this.codeDialog},EMarkdownEditor.showDialog);this.insertCodeBtn=jQuery("#"+a+"_insert_code_btn");this.insertCodeBtn.bind("click",{widgetId:a},EMarkdownEditor.insertCode);
this.selectCode=jQuery("#"+a+"_select_code");this.selectCode.bind("change",{widgetId:a},EMarkdownEditor.onSelectCode);this.codeInput=jQuery("#"+a+"_code_input");this.uploadLink=c;this.addImageBtn=jQuery("#"+a+"_add_image_btn");this.addImageBtn.bind("click",{widgetId:a},EMarkdownEditor.showUploadDialog);this.uploadFileLink=b;this.addFileBtn=jQuery("#"+a+"_add_file_btn");this.addFileBtn.bind("click",{widgetId:a},EMarkdownEditor.showUploadFileDialog);this.addCutBtn=jQuery("#"+a+"_add_cut_btn");this.addCutBtn.bind("click",
{widgetId:a},EMarkdownEditor.insertCut);this.mirrorEditor=eval(a+"_code_input_codemirror");this.mirrorEditor.on("change",(a)=>{d.codeInput.val(a.getValue())});this.markdownMirrorEditor=eval(a+"_codemirror");this.markdownMirrorEditor.on("change",(a)=>{d.textarea.val(a.getValue())})};EMarkdownEditor.onSelectCode=(a)=>{a=EMarkdownEditor.get(a.data.widgetId);a.mirrorEditor.setOption("mode",LANGUAGES[a.selectCode.val()])};
EMarkdownEditor.insertCut=(a)=>{a.preventDefault();(a=EMarkdownEditor.get(a.data.widgetId))&&a.markdownMirrorEditor.replaceSelection("\n___\n");return!1};EMarkdownEditor.showUploadDialog=(a)=>{a.preventDefault();var c=a.data.widgetId,b=EMarkdownEditor.get(c);if(b.uploadLink.length){var d=jQuery("#uploadDialog");d.length?(EMarkdownEditor.initUploadDialog(c),d.modal("show")):jQuery.ajax({url:b.uploadLink,type:"GET",dataType:"json",success(b){jQuery(b.uploadDialog).appendTo(jQuery("body"));EMarkdownEditor.showUploadDialog(a)}})}};
